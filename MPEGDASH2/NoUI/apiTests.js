...
request.open("GET", "/MPEGDASH2/song/output/audio/und/mp4a/init.mp4", true);
...
request.onload = function() {
    ...
    request2.open("GET", "/MPEGDASH2/song/crylight_fragmented.mp4", true);
    request2.responseType = "arraybuffer";

    request2.onload = function() {
        var partMP4 = request2.response;

        audioContext.decodeAudioData(partMP4, function(streamDecoded) {
